...
# def signup(request):
#     """
#     회원가입 시 UserCreationForm(아이디, 비밀번호, 비밀번호확인) 사용방식
#     """
...
class CustomPasswordChangeView(PasswordChangeView):
    """
    PasswordChangeView에서 정의한 template_name 은
    registration/password_change_form.html 을 찾게 되어 있음
