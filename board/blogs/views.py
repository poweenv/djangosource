...
def post_edit(request,post_id):
    ...
    return render("blogs/post_edit.html",{"form":form})
...
def post_like(request,post_id):
    ...
    return JsonResponse({"likes":post.like.count(),"is_liked":is_liked_change})