...
class Question(models.Model):
    ...
    modified_at = models.DateTimeField(verbose_name="수정 날짜",null=True,blank=True)
    # 추천 필드
...
# 댓글 테이블
# 질문, 답변 댓글
# 번호(자동생성), 작성자, 작성날짜, 수정날짜, 외래키(질문,답변 구분을 위해)
